...
QUANTUM="6000";
VERSION="1.4.1";
CONF="/etc/systemd/speedrestrictor.conf";
CONFLEGACY="/etc/conf.d/speedrestrictor.conf";
...
MODES:
   speedrestrictor -a <adapter> -d <rate> -u <rate>
   speedrestrictor -c -a <adapter>
   speedrestrictor -s -a <adapter>

EXAMPLES:
   speedrestrictor -a eth0 -d 1024 -u 512
   speedrestrictor -a eth0 -u 512
   speedrestrictor -c -a eth0
   speedrestrictor -p -f foo.conf
